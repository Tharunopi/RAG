...
class chain:
    ...
    def get_chain_for_construction(self) -> list:
        ...
        try:
            ...
            template = """You are an intelligent query refiner. Your task is to take an initial user query and generate multiple diverse but semantically relevant sub-queries that explore different possible interpretations or aspects of the user’s intent.
